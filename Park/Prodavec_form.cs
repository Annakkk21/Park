...
namespace Park
{
    public partial class Prodavec_form : Form
    {
        public Prodavec_form()
        {
            InitializeComponent();
        }

        private void Prodavec_form_Load(object sender, EventArgs e)
        {
        ...
        private void Prodavec_form_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
